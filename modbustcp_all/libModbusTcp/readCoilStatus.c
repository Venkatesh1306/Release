...
* Input Frame  :{0x00, 0x01, 0x00, 0x02, 0x00, 0x06, 0x03, 0x01, 0x00, 0x01, 0x00, 0x09}
* Output Frame :{0x00, 0x01, 0x00, 0x02, 0x00, 0x05, 0x03, 0x01, 0x02, 0xff, 0x01}
...
uint16_t
readCoilStatus(uint8_t *p_modbusTxBuf, const uint16_t *p_dataMemory, mbPacketParse_t *p_parseModbusTcpData) {
    ...
    unsigned int NoOfBits = 0, Regbit = 0, reg = 0, regTx = 0, byte_index = 0, bit_count = 0, wordOffset = 0, m = 0, RegbitTx = 0;
    uint16_t Txtempbuf[MaxSizeTxtempbuf];
    for (m = 0; m < MaxSizeTxtempbuf; m++) {
        Txtempbuf[m] = 0; /* initializing all values of Txtempbuf[m] = 0 */
    }
    unsigned int byte_count = 0, limit = 0, coil_bit = 0;
